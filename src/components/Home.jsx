            ...
            <div className='gradientBg rounded-xl rounded-br-[80px] md:p-9 px-4 py-9'>
                <div className='flex flex-col md:flex-row-reverse justify-between items-center gap-9'>
                    ...
                    <div className='md:w-3/5'>
                        ...
                        <div>
                            <button className='text-white border-2 border-solid border-transparent hover:border-primary hover:text-white transition-all duration-300 py-3 px-4 font-bold rounded-2xl bg-[#E396E6] hover:bg-transparent shadow-xl'>Agende sua consulta</button>
